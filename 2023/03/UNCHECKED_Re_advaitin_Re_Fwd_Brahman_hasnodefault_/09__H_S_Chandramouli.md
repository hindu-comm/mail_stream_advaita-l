+++
title = "09 H S Chandramouli"
date = "2023-03-13"
upstream_url = "https://lists.advaita-vedanta.org/archives/advaita-l/2023-March/059859.html"
+++
[Archive link](https://lists.advaita-vedanta.org/archives/advaita-l/2023-March/059859.html)

Namaste.

I am not sure if the following citation from Srimad Bhagavatam has indeed
been mentioned and discussed in this or other threads on the same subject.
So I am mentioning it here

SB 10-2-16 to 19.

Do these not clearly state that the sharIra of Sri Krishna is not bhaytika?
Perhaps commentary of Sridhara Swamin might also throw some light.

Sorry for resuming the thread. Felt there may be some useful info here.
...
On Wed, Mar 1, 2023 at 4:39 PM Venkatraghavan S via Advaita-l <
...
> > >
> > > The only logical necessity for postulating anything special for the
> forms
> > > of Ishvara, is that the forms are not karma-janya. There was never a
> past
...
> > >> Namaste Subbuji,
> > >>
> > >> I don't have a strong opinion on the subject, but it appears to me
> that
> > a
...
> > >>
> > >> The intent with saying that the body is mAyAmaya sharIra is not that
> the
...
> > and
> > >> therefore is not subject to the physical / biological restrictions of
> a
> > >> bhautika sharIra.
> > >>
> > >> There are several examples that come up in advaita sharada of this
> idea:
> > >>
...
> > >> यथा लोके कश्चिज्जातो देहवानालक्ष्यते, एवमहमपि मायामाश्रित्यत्या
> स्ववशया
...
> > आरम्भणाधिकरणे
> > >> व्युत्पादयिष्यमाणेन न्यायेन शरीरेऽपि व्यावहारिकप्रामाण्योपपत्तेश्च ।
> न च
...
> > >> Here he does admit that Ishvara's body is pAncabhautika, but his
> intent
...
> > >>> Dear Venkat ji,
> > >>>
> > >>> Thanks for sharing the Vichara sagara pages on the topic.  Upon
> reading
...
> > >>> themselves not a product of punya or otherwise of Rama and Krishna;
> the
> > >>> jivas' punya/papa alone is the cause of the sukha, etc.
> > >>>
> > >>> My question is:  In the 13th chapter of the BG, kshetram (prakriti)
> is
> > >>> defined as:
> > >>>
...
> > the
> > >>> pancha koshas (including the sense/action organs, manas, buddhi,
> prana,
...
> > >>> duhkha, etc. All of this is together called kshetram: prakriti and
> its
...
> > contact
> > >>> of the sense..organs of the jivas with those avatara bodies. The
> gopis
> > had
...
> > sparsha,
> > >>> etc. Taking the 13th chapter specification of the kshetram, the
> avatara
> > >>> bodies will have to be admitted to be products of prakriti. Only
> murta
...
> > >>> anubhava had before. In this case, the bhakta has seen/read the
> puranas
> > >>> account of the rupam of the Lord and that input helps the mano
> vrittis.
...
> > during
> > >>> such a vision, had given a fruit or any other object, that will
> remain
> > even
> > >>> after the vision ceases and shall be a proof of the vision.  Such
> fruit
...
> > >>>> Namaste Raghav ji,
> > >>>>
> > >>>> Please find attached an interesting discussion in the Sanskrit
> Vichara
> > >>>> Sagara on the untenability of avatAra sharIra to be bhautika.
> > >>>> As its a file attachment, it will be rejected by the advaita-l
> server,
> > >>>> others can view it by seeing the corresponding message in the
> advaitin
