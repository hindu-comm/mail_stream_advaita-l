...
title = "55 Srirudra"
date = "2014-12-15"
upstream_url = "https://lists.advaita-vedanta.org/archives/advaita-l/2014-December/037811.html"

+++
[Archive link](https://lists.advaita-vedanta.org/archives/advaita-l/2014-December/037811.html)

Dear
As per BS also Brahman became the many by desiring to be so.Akamayatha is the word used.So what you say is correct from my view point.R.Krishnamoorthy.

Sent from my iPad

> On 15-Dec-2014, at 8:23 pm, H S Chandramouli via Advaita-l <advaita-l at lists.advaita-vedanta.org> wrote:
> 
> Dear Sri Venkatesh Murthyji,
> 
> 
> Reg If you say Brahman is Creator it will make Brahman the Author of this
> Illusion. But Brahman cannot create Illusions. The Illusion is Maayaa only.
> 
> 
> I feel the term illusion for Creation is not appropriate because it always
> leads one to automatically infer, mostly due to our mental training , that
> it is produced out of Nothing. It is more appropriate to train our mind to
> think of Creation as appearance OF Brahman instead of illusion. It helps in
> our sadhana also as it always keeps us aware of the Reality and checks our
> response to our experience of the world. A suggestion made in good faith
> and not to be misunderstood, even if you were not to agree with it.
> 
> 
> Regards
> 
...
>> something.
>> 
>> But if someone says now there is Creation it must be Nothing only. Because
...
>>> responsible for Creation. Since Brahman is presented as Actionless on its
...
>>> Brahman. Its status of existence  is considered Anirvachaniya because it
...
>> created
>>>> from Nothing the Universe also will be Shunya only. This is coming from
>>>> Sat
...
>>>> creates Universe the Universe will be Paramartha Satya but it is not the
>>>> case.
>>>> 
...
>> from
>>>>> Maaya either. Creation is from Brahman only, but only an Appearence in
>>>>> Brahman. Meaning thereby that it has a lower level of Reality as
>>>> compared
>>>>> to Brahman itself. Maaya is considered as an intermediary step between
>>>>> Brahman and Creation and of the same order of Reality as Creation. For
...
>>>> lends
>>>>> itself to be easily integrated into any analysis of Creation. Loosely
...
>>>>>> 
>>>>>> There is an "achala paripurNa" school in Andhra which calls reality
>> as
...
>>>>>>>> 
>>>>>>>> In Advaita we say the Universe is produced by Maayaa. But Maayaa
>>>> is
>>>>> not
