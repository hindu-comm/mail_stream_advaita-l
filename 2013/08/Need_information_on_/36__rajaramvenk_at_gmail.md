+++
title = "36 rajaramvenk at gmail.com"
date = "2013-08-22"
upstream_url = "https://lists.advaita-vedanta.org/archives/advaita-l/2013-August/035370.html"

+++
[Archive link](https://lists.advaita-vedanta.org/archives/advaita-l/2013-August/035370.html)

I went to Samskrta Bharathi's kshibhiram for a few days and it is very good pedagogy. My parents completed up to Kovida and speak, read and write fluently. My mother taught me to speak family matters in just one week flat. 
But one of my friends who is a paninian expert thrashed my confidence in speaking and  termed it as "prakrtam". I didn't pursue samskrta bharathi further because he convinced me that I will have to unlearn a lot.  My parents are of the view that I am at a loss because of that. 

My friend's view is that sanskrtam is a created language and therefore we should first learn panini. We should learn usage only as an example of paninian sutras.  Couple of friends are teaching through texts such as BhG, Ramayana etc. All these 

IMO, scholars should come together to support samskrta  bharathi correcting any flaws they may have. 
Sent from my BlackBerry® wireless device

-----Original Message-----
From: Ajit Krishnan <ajit.krishnan at gmail.com>
Sender: "Advaita-l" <advaita-l-bounces at lists.advaita-vedanta.org>Date: Wed, 21 Aug 2013 23:36:29 
To: Bharadwaj Devaguptapu<dr.d.bharadwaj at gmail.com>
...
I omitted the list from my previous reply since a prolonged thread on this
topic has little to do with the charter of this list. I'm responding one
more time to try and clear up some misconceptions.

Samskrita Bharati's basic methodology is to teach samskritam through
samskritam and gradually teach concepts.

To bootstrap this process, a few people did some research and developed an
introductory course. Based on field trials, a few prayogas were overlooked,
for the duration of this 20 hour introductory course.

I repeat ... for the duration of the introductory course alone, some
prayogas are knowingly overlooked.

This is not done to alter or dilute Samskritam, but to allow people to
speak simple 3-5 word sentences in a short period of time.

Following this, the full breadth and depth of Samskritam is taught.
Madhyama-puruSha and dvi-vacanam are taught and encouraged. Things like
'asti' that should be omitted are omitted. The use of all lakAras is
encouraged. The use of hanlata words and Atmanepadi forms is encouraged.
etc.

I've been involved with Samskrita Bharati activities, on and off, for a few
years now. Long enough to be able to observe things first hand. It's
actually quite easy for me to "prove" my point ... just look at the books
that Samskrita Bharati publishes, and the prayogas used there. I can find
hundreds of examples of all these prayogas in their publications.

The criticisms that you made, IMO, display a fundamental lack of Samskrita
Bharati's methodology. From my perspective, you are judging a book by it's
cover.

There are valid criticisms -- sandhi is totally missing in samskrita
bharati publications, and along with it, the kind of sentence construction
found in bhashyas and shlokas that comes along with sandhi.

I used strong, direct language in my first reply, because I speak plainly,
and because I have enough context and plenty of references to back up my
assertions.

Regarding the personal comments ... I was not hurt or angered by your curt
reply. If I was, I wouldn't have asked a genuine follow-up question. I was
amused that you saw me as less than cordial, and decided to play the part.
It was childish, and I apologize unreservedly.
...
On Wed, Aug 21, 2013 at 10:04 PM, Dr D Bharadwaj
...
> I understand, Sir. But please forgive me for refusing to. The list would
> be too long and too old for and not so well motivated to do long typing.
> Also, they might generate controversy as the expressions themselves are
> quite 'legal', 'grammatically correct' and questionable only if I share my
> some insight.
>
...
>
> The bhAShA IS indeed our culture - saMskRti. We need to, *at least,*pause, think, discuss and proceed with caution. The self-righteous rhetoric
> of an effervescent reformist is not always as right as it seems on the
> surface.
>
...
>>
>>
>> On Wed, Aug 21, 2013 at 7:31 PM, Dr D Bharadwaj <dr.d.bharadwaj at gmail.com
>> > wrote:
>>
...
>>> highly
>>> dedicated, self-less volunteers personally motivated by Sri Krishna
>>> Sastry
...
>>> survives in the organization to a reasonable level, even when,
>>> inevitably,
...
>>> Bharati succeeds (with the collectivity in its efforts to make sanskrit
>>> as
>>> sarala as it intends) can be understood only by those that
>>> comprehensively
>>> understood the pure, pristine, classical samskritam as bhAShA, not of a
>>> nation alone, but of a unfathomably deep, hoary culture and that it is
>>> the
...
>>> present passing unfortunate culture, not yet 'massified' (to use
>>> Toffler's
...
>>> saarthakata, after I learnt how to 'understand' the RShi hRdayam, the
>>> true
>>> way to approach the ArSha Texts, by understanding the right way,
>>> SaMskRtam
>>> as a bhAShA .
>>>
...
>>> my
>>> opinion. is just a dispassionate personal observation mine, of a
>>> situation
...
>>> the
>>> > > Magnificent Edifice of Sanskrit. Indifferent to the fall-out, they
>>> are
>>> > > inventing many 'expressions' in Snaskrit twisting them, to make them
>>> > > suitable and comparable to the corresponding the loose versions of
>>> the
...
>>> judge
>>> > the impact of the group as having a positive outcome that far
>>> outweighs the
>>> > negative.
>>> >
>>> >
...
>>> >
>>> >
>>> > Finally, I agree with your observation that understanding the content
>>> of
>>> > the
...
>>> > > > Namaste
>>> > > >
>>> > > > The Mutts have to take up this matter very seriously. Today they
>>> are
>>> > not
...
>>> > language.
>>> > We fail to appreciate and support them in tangible ways. Instead, we
>>> sit
>>> > and
...
>>> > conversant
>>> > with some basics, then the process of learning in this manner is made
>>> a bit
...
>>> teachers
>>> > ask their long distance students to get a few weeks of in-person
>>> classes
>>> > per
...
>>> work.
>>> > If
>>> > you are willing to put in the time and effort, you can indeed have
>>> some of
...
>>> > society
>>> > > > > that there are few who can claim to have understood
>>> prasthAnatrayI
...
>>> some
>>> > of
>>> > us are very particular about word usage and for the most part, we
>>> intend
...
>>> >
>>> > > > > >
>>> > > > > > Is any senior vaidhika in sringeri or any other place
>>> protecting
>>> > > > vaidhika
