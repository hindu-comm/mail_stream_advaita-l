...
date = "2016-12-02"
upstream_url = "https://lists.advaita-vedanta.org/archives/advaita-l/2016-December/043570.html"

+++
[Archive link](https://lists.advaita-vedanta.org/archives/advaita-l/2016-December/043570.html)

On Fri, Dec 2, 2016 at 6:06 PM, Venkatraghavan S via Advaita-l <
...
Further to hold Ishwara's prakriti is of just one (sattva) guṇa will be
flawed since Ishwara is the one who performs the srishti (rajas), sthiti
(sattva) and laya (tamas) functions which need all the guṇa-s.
...
> > vishepa from the jeeva's point -as we find tamasic, rajasic and satvic
> with
...
> > maaya with tamasic part of praKriti (maaya) to create all the inert
> matter
...
> > as reflection in maaya oneside, and Iswara with maaya shakti on the
> other.
...
> > saa maayaa - and reflection of pure consciousness in maaaya as Iswara -
> are
...
> > fellow who thought he last a chain that his wife gave and ran to his
> friend
> > only to discover that he had the chain all the time even when he thought
> he
> > lost it.
...
> > discover that all these explanations and classifications are not
> necessary
...
> > consciousness in that mAya is Ishvara. avidyA is the name for the
> infinite
...
> > Ishvara does not. Here avidyA and mAya are two amshas of  the same
> upAdhi.
...
> > this view states that Ishvara is the reflection of consciousness in
> avidyA
> > (the kAraNa) and jIva is the reflection of consciousness in antahkaraNAm
> > (the kArya). In this view, avidyA and mAya are not distinguished at all
> as
> > Ishvara is said to have the upAdhi of avidyA.
> >
> > In summary, the prevalent views are 1) one is a subset of the other 2)
> the
...
> different
> > in VedAnta shAstra is correct, as there are some groups within the
> advaita
...
> > related to the other in some fashion (from absolute identity in one end
> of
...
> > within the advaita sampradAya, but among the ones prevalent in
> DIkshitar's
...
> > advaita-l at lists.advaita-vedanta.org> wrote:
> >
> > > Venkatraghavan: If he only does the former, but notthe latter, we end
> up
> > > with sAnkhya darshana, where the jIva identifies withkUtastha, but
> still
> > > attributes reality to prakriti, seen in the form of theworld. This
> would
...
> > BMI
> > > which is a product of Iswara sRiShTiremains.  I am not sure I
> understand
> > > therest of your arguments. ------------------------------
> ----Venkatraghavan:
> > The
> > > purpose of shAstra is to givemoksha, so any system should not only be
> > > internally consistent, it should alsoseek to achieve that purpose in
> the
...
> do
> > > this. The appearance of the world is no proof of either the existence
> of
...
> > > gone, I am moving fromjeeva-Iswara-jagat triangular format to the
> binary
> > > format of aatma-anaatma. Yesat transactional level – there is a teacher
> > and
> > > there are students and theteaching is going on. Hence knowledge does
> not
...
> > > evidenced by the fact that is notsubjective error but objective error
> in
